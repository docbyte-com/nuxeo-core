...
public class RenderingServiceTest {
    ...
    // NXP-28512
    @Test
    public void testRenderDocumentWithStringInput() throws Exception {
    ...
    // NXP-28512
    @Test
    public void testRenderDocumentWithRefInput() throws Exception {
        try (OperationContext ctx = new OperationContext(session)) {
    ...
    // NXP-28512
    @Test
    public void testRenderDocumentFeedWithStringInput() throws Exception {
        try (OperationContext ctx = new OperationContext(session)) {
    ...
    // NXP-28512
    @Test
    public void testRenderDocumentFeedWithRefsInput() throws Exception {
        try (OperationContext ctx = new OperationContext(session)) {
            DocumentRefList refList = new DocumentRefListImpl(List.of(src.getRef(), dst.getRef()));
            ctx.setInput(refList);
            OperationChain chain = new OperationChain("testRenderDocumentFeed");
