 ...
 *     bstefanescu
 */
package org.nuxeo.ecm.automation.io.rest.documents;
...
import org.nuxeo.ecm.automation.io.rest.InputStreamDataSource;
...
public class MultipartBlobs extends MimeMultipart {
    ...
    public void addBlob(Blob blob) throws MessagingException, IOException {
        ...
        part.setDataHandler(
                new DataHandler(new InputStreamDataSource(blob.getStream(), blob.getMimeType(), blob.getFilename())));
