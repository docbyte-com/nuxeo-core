...
public class BaseDirectoryDescriptor implements Cloneable {
     ...
     * @since 11.1
     */
    public static final String DATA_LOADING_POLICY_LEGACY = "legacy";
     ...
     * @since 11.1
     */
    public static final String DATA_LOADING_POLICY_NEVER_LOAD = "never_load";
     ...
     * @since 11.1
     */
    public static final String DATA_LOADING_POLICY_SKIP_DUPLICATE = "skip_duplicate";
     ...
     * @since 11.1
     */
    public static final String DATA_LOADING_POLICY_REJECT_DUPLICATE = "reject_duplicate";
     ...
     * @since 11.1
     */
    public static final String DATA_LOADING_POLICY_UPDATE_DUPLICATE = "update_duplicate";
     ...
     * @since 11.1
     */
    public static final List<String> DATA_LOADING_POLICIES = List.of(DATA_LOADING_POLICY_LEGACY,
            DATA_LOADING_POLICY_NEVER_LOAD, DATA_LOADING_POLICY_SKIP_DUPLICATE, DATA_LOADING_POLICY_REJECT_DUPLICATE,
    ...
    /**
     * Returns the dataLoadingPolicy; default is {@link #DATA_LOADING_POLICY_NEVER_LOAD}.
     *
     * @since 11.1
     */
    public String getDataLoadingPolicy() {
        if (StringUtils.isBlank(dataLoadingPolicy)) {
            return DATA_LOADING_POLICY_LEGACY;
        }
