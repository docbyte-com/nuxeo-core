...
public class SearchTest {
    ...
    public void iCanPerformQueriesWithNamedParametersOnRepository() {
        ...
        httpClient.buildGetRequest(QUERY_EXECUTE_PATH)
                  .addQueryParameter("query", "SELECT * FROM Document WHERE ecm:parentId = :parentIdVar " + //
    ...
    @Test
    public void iCanPerformPageProviderWithNamedParametersInWhereClauseWithDoc() {
        httpClient.buildGetRequest(getSearchPageProviderExecutePath("namedParamProviderWithWhereClauseWithDoc"))
                  .addQueryParameter("np:title", "Folder 0")
                  .executeAndConsume(new JsonNodeHandler(),
                          node -> assertEquals(1, JsonNodeHelper.getEntriesSize(node)));
