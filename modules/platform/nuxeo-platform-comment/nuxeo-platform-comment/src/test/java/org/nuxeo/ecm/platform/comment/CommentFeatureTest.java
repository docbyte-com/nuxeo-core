...
/**
 * @since 2025.0
 * @implNote was previously an inner class of {@link CommentFeature}
 */
@RunWith(FeaturesRunner.class)
@Features(CommentFeature.class)
// bundle that needs mail to be deployed whereas most of the test doesn't need them
@BlacklistComponent("org.nuxeo.ecm.platform.comment.service.notification") // needs NotificationService & MailService
