...
public class LogEntryCSVWriter extends AbstractCSVWriter<LogEntry> {
    ...
    public static final List<String> DEFAULT_PROPERTIES = List.of(LOG_ID, LOG_CATEGORY, LOG_PRINCIPAL_NAME, LOG_COMMENT,
            LOG_DOC_LIFE_CYCLE, LOG_DOC_PATH, LOG_DOC_TYPE, LOG_DOC_UUID, LOG_EVENT_ID, LOG_REPOSITORY_ID,
