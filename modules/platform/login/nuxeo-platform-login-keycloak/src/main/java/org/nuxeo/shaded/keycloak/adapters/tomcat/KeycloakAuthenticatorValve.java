...
public class KeycloakAuthenticatorValve extends AbstractKeycloakAuthenticatorValve {
    ...
    protected boolean forwardToErrorPageInternal(Request request, HttpServletResponse response, Object loginConfig)
        ...
        try {
            Method method = null;
            /*
             * for (Method m : getClass().getDeclaredMethods()) { if (m.getName().equals("forwardToErrorPage")) { method
             * = m; break; } }
             */
            method = FormAuthenticator.class.getDeclaredMethod("forwardToErrorPage", Request.class,
