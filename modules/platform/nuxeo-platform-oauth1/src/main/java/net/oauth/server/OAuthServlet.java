...
public class OAuthServlet {
    ...
    /**
     * Extract the parts of the given request that are relevant to OAuth. Parameters include OAuth Authorization headers
     * and the usual request parameters in the query string and/or form encoded body. The header parameters come first,
     * followed by the rest in the order they came from request.getParameterMap().
     * 
     * @param URL the official URL of this service; that is the URL a legitimate client would use to compute the digital
     *            signature. If this parameter is null, this method will try to reconstruct the URL from the HTTP
    ...
    /**
     * Return the HTML representation of the given plain text. Characters that would have special significance in HTML
     * are replaced by <a href="http://www.w3.org/TR/html401/sgml/entities.html">character entity references</a>.
