...
Sample call using curl :
    ...
    curl -H 'Content-Type:application/json' -X POST -d '{"params":{"batchSize":5000}}' -u Administrator:Administrator http://127.0.0.1:8080/core/api/v1/automation/Audit.StartMigration
