...
@Features({ AutomationCoreFeature.class, AutomationServerFeature.class, RepositoryLightElasticSearchFeature.class })
public class ElasticsearchAutomationFeature implements RunnerFeature {
}
