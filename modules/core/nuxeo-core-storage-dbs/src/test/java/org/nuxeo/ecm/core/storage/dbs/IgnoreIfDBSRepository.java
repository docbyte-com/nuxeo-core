 ...
 * @since 2025.0
 */
public class IgnoreIfDBSRepository implements ConditionalIgnoreRule.Condition {

    @Override
    public boolean shouldIgnore() {
        return CORE_SERVICE_VALUE.equals(STORAGE_MEM) || CORE_SERVICE_VALUE.equals(STORAGE_MONGODB);
    }
