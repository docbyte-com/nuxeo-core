...
public abstract class AbstractTestTrashService {
    ...
    public void testUntrashThreeLevels() {
        var folder1 = session.createDocumentModel("/", "folder1", "Folder");
        folder1 = session.createDocument(folder1);
        var folder2 = session.createDocumentModel("/folder1", "folder2", "Folder");
        folder2 = session.createDocument(folder2);
        var folder3 = session.createDocumentModel("/folder1/folder2", "folder3", "Folder");
