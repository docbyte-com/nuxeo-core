...
/**
 * The implementation of {@link OpenSearchHintQueryBuilder} for the <strong>"geo_shape"</strong> Elasticsearch hint
 * operator.
 *
 * @since 11.1
 */
public class GeoShapeOpenSearchHintQueryBuilder extends AbstractGeoOpenSearchHintQueryBuilder {
