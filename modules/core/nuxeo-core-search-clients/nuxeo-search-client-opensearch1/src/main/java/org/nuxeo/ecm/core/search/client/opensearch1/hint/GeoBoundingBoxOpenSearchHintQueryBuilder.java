...
/**
 * The implementation of {@link OpenSearchHintQueryBuilder} for the <strong>"geo_bounding_box"</strong> Elasticsearch
 * hint operator.
 *
 * @since 11.1
 */
public class GeoBoundingBoxOpenSearchHintQueryBuilder extends AbstractGeoOpenSearchHintQueryBuilder {
