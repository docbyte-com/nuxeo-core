...
/**
 * Abstract implementation of {@link OpenSearchHintQueryBuilder} that manages the geo queries.
 *
 * @since 11.1
 */
public abstract class AbstractGeoOpenSearchHintQueryBuilder implements OpenSearchHintQueryBuilder {
    ...
    protected String[] validate(Object value, int arrayLength, String message) {
        ...
        return Arrays.asList(values).toArray(String[]::new);
    }
