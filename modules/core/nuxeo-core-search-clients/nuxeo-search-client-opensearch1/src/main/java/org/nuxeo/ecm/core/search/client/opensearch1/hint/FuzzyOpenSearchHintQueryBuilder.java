...
/**
 * The implementation of {@link OpenSearchHintQueryBuilder} for the <strong>"fuzzy"</strong> Elasticsearch hint
 * operator.
 *
 * @since 11.1
 */
public class FuzzyOpenSearchHintQueryBuilder implements OpenSearchHintQueryBuilder {
     ...
     * <p>
     *
     * @return {@link org.opensearch.index.query.FuzzyQueryBuilder}
     */
    @Override
