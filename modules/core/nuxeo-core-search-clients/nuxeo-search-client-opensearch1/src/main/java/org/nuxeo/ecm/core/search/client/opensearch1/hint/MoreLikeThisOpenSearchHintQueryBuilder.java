...
/**
 * The implementation of {@link OpenSearchHintQueryBuilder} for the <strong>"more_like_this"</strong> Elasticsearch hint
 * operator.
 *
 * @since 11.1
 */
public class MoreLikeThisOpenSearchHintQueryBuilder implements OpenSearchHintQueryBuilder {
    ...
    public static MoreLikeThisQueryBuilder.Item[] getItems(Object value) {
        ...
        for (int i = 0; i < values.length; i++) {
            ret[i] = new MoreLikeThisQueryBuilder.Item(null, (String) values[i]);
        }
        return ret;
    }
}
