...
/**
 * The implementation of {@link OpenSearchHintQueryBuilder} for the <strong>"multi_match"</strong> Elasticsearch hint
 * operator.
 *
 * @since 11.1
 */
public class MultiMatchOpenSearchHintQueryBuilder implements OpenSearchHintQueryBuilder {
