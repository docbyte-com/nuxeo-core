...
/**
 * The implementation of {@link OpenSearchHintQueryBuilder} for the <strong>"match_phrase_prefix"</strong> Elasticsearch
 * hint operator.
 *
 * @since 11.1
 */
public class MatchPhrasePrefixOpenSearchHintQueryBuilder implements OpenSearchHintQueryBuilder {
