...
/**
 * The implementation of {@link OpenSearchHintQueryBuilder} for the <strong>"simple_query_string"</strong> Elasticsearch
 * hint operator.
 *
 * @since 11.1
 */
public class SimpleQueryStringOpenSearchHintQueryBuilder implements OpenSearchHintQueryBuilder {
