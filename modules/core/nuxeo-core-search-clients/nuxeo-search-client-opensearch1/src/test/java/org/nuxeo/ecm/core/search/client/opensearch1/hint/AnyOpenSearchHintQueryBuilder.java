 ...
 * @since 11.1
 */
public class AnyOpenSearchHintQueryBuilder implements OpenSearchHintQueryBuilder {

    @Override
    public QueryBuilder make(EsHint hint, String fieldName, Object value) {
        throw new UnsupportedOperationException("This operation is not any more supported");
    }
}
