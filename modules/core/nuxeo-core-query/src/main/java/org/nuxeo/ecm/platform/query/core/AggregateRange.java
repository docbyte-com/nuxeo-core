 ...
 * @since 2025.0
 */
public class AggregateRange extends AggregateBase<BucketRange> {

    public AggregateRange(AggregateDefinition definition, DocumentModel searchDocument) {
        super(definition, searchDocument);
        if (!AGG_TYPE_RANGE.equals(definition.getType())) {
