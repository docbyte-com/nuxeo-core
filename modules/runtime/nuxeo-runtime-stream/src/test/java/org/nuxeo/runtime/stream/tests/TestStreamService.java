...
public class TestStreamService {
    ...
    public void testMixedLogConfig() {
        ...
        // An explicit mem stream defined by conf doesn't support subscribe
        assertFalse(manager.supportSubscribe(Name.ofUrn("mem/mem-foo")));
        if (new IgnoreKafka().shouldIgnore()) {
            ...
            // A random stream is handled by default Mem log manager without subscribe support
